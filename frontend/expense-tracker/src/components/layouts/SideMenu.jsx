    ...
    <div className="w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 p-5 sticky top-[61px] z-20 ">
        <div className="flex flex-col items-center justify-center gap-3 mt-3 mb-7">
            {user ?. profileImageUrl ? (
                <img src={user?.profileImageUrl || ""} alt="profileImage" className="" />
            ) : 
             <CharAvatar
            ...
            style="text-xl"
            />
            // <CgProfile className=" w-20 h-20 bg-zinc-400 rounded-full " />
            }
        ...
        {SIDE_MENU_DATA.map((item, index) =>(
            ...
            className={`w-full flex items-center gap-4 text-[15px] cursor-pointer  ${
                activeMenu == item.label ? "text-white bg-primary cursor-pointer ": ""
